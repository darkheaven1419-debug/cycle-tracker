...
const STATIC_ASSETS = [
  ...
  './js/calendar/calendar-state.js',
  './js/calendar/calendar-accessibility.js',
  './js/calendar/calendar-renderer.js',
  './js/calendar/calendar-interaction.js',
  './js/calendar/calendar-animations.js',
  './js/calendar/calendar-main.js',
  './js/barry.js',
  './js/render-mood.js',
  './js/render-love.js',
  './js/render-misc.js',
