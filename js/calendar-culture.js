...
var EXTRA_HOLIDAYS = [
  ...
  {d:'2026-04-20',name:{sr:'Festival kiše za žito',zh:'谷雨节',en:'Grain Rain Festival'},country:'cn',icon:'🌾',
   desc:{sr:'Poslednji prolećni solarni termin — vreme za setvu i molitvu za bogatu žetvu.',
  ...
  {d:'2026-09-15',name:{sr:'Festival gladnih duhova',zh:'中元节',en:'Hungry Ghost Festival'},country:'cn',icon:'🏮',
   desc:{sr:'Dan kada se pali tamjan za duše predaka. Noćas granica između svetova postaje tanja.',
  ...
  {d:'2026-11-01',name:{sr:'Festival donjeg izvora',zh:'下元节',en:'Xiayuan Festival'},country:'cn',icon:'🙏',
   desc:{sr:'Dan molitve Bogu Vode da smiri reke i donese mir.',
  ...
  {d:'2026-12-22',name:{sr:'Zimski solsticij festival',zh:'冬至节',en:'Winter Solstice Festival'},country:'cn',icon:'🥟',
   desc:{sr:'"Zimski solsticij je važniji od Nove Godine!" Porodica se okuplja uz jufke.',
...
// ── Seasonal poems ────────────────────────────────────────────
var SEASONAL_POEMS = {
  0: { title:{zh:'元日',sr:'Novogodišnji dan',en:'New Year\'s Day'}, author:'王安石', dynasty:'宋',
    explain:{sr:'Pesma slavi kinesku Novu Godinu. "Peach-wood signs" (桃符) su preteče današnjih crvenih papirnih amajlija koje Kinezi lepe na vrata za sreću.',
  ...
  2: { title:{zh:'春晓',sr:'Prolećno jutro',en:'Spring Morning'}, author:'孟浩然', dynasty:'唐',
    explain:{sr:'Najpoznatija kineska pesma o proleću. Pesnik se budi i shvata da je proleće već tu — ptice pevaju, a noćna kiša je oborila latice cveća. Jednostavna, a tako živa slika.',
  ...
  5: { title:{zh:'小池',sr:'Mali ribnjak',en:'Little Pond'}, author:'杨万里', dynasty:'宋',
    explain:{sr:'Letnja minijatura — izvor, senka drveta, lotosov pupoljak i vilin konjic. Pesnik gleda mali ribnjak i vidi ceo svet u njemu. Kineska poezija voli ovakve "male velike stvari".',
  ...
  8: { title:{zh:'山居秋暝',sr:'Jesenje veče u planinama',en:'Autumn Evening'}, author:'王维', dynasty:'唐',
    explain:{sr:'Wang Wei je bio pesnik i slikar — njegove pesme su kao slike. Ovde slika jesenje veče u planinama posle kiše: svež vazduh, mesečina kroz borove, potok preko kamenja. Savršen mir.',
  ...
  11: { title:{zh:'江雪',sr:'Sneg na reci',en:'River Snow'}, author:'柳宗元', dynasty:'唐',
    explain:{sr:'Najpoznatija kineska zimska pesma. Hiljade planina — ni jedne ptice. Deset hiljada staza — ni jednog čoveka. Samo jedan starac u čamcu, peca na zaleđenoj reci. Potpuna tišina i samoća — ali i neverovatna unutrašnja snaga.',
...
function renderSeasonalPoemCard() {
  ...
  el.innerHTML =
    '<div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">' +
      ...
      '<span style="font-size:.6rem;opacity:.45">— ' + poem.author + ' · ' + poem.dynasty + '</span>' +
    '</div>' +
    '<div class="poem-body" style="white-space:pre-line">' + lines + '</div>' +
...
function renderCultureExplain() {
  ...
  topics.forEach(function(t) {
    h += '<div style="margin-bottom:10px;padding:8px 10px;background:var(--card);border-radius:10px;border-left:3px solid var(--love)">' +
      ...
      '<div style="font-size:.65rem;color:var(--text-muted);line-height:1.6">' + _CL(CULTURE_EXPLAIN[t.key]) + '</div>' +
      '</div>';
  });
  h += '<div style="text-align:center;font-size:.6rem;color:var(--text-muted);margin-top:6px;cursor:pointer" onclick="document.getElementById(\'cultureExplain\').style.display=\'none\'">' + _CL({sr:'✕ zatvori',en:'✕ close','zh-CN':'✕ 关闭'}) + '</div>';
  el.innerHTML = h;
