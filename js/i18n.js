...
const I18N = {
'sr': {
  appTitle:'Anđelin Ciklus', theme:'Tamni režim', themeHint:'Prebacivanje između tamnog i svetlog režima',
  weekdays:['Pon','Uto','Sre','Čet','Pet','Sub','Ned'],
  months:['Jan','Feb','Mar','Apr','Maj','Jun','Jul','Avg','Sep','Okt','Nov','Dec'],
  today:'Danas', tabs:['Početna','Statistika','Simptomi','Dnevnik','Kineski','Podeš.'],
  ...
  knowledgeToggle:'📖 Saznaj više o ovoj fazi ▾', knowledgeToggleHide:'Sakri ▴',
  ...
  emptyState:'Dodirni datum za prvi unos', emptySymptom:'Dodirni datum na kalendaru<br>da uneseš simptome',
  ...
  stats:{cycleTitle:'📈 Statistika ciklusa',historyTitle:'📅 Nedavni ciklusi',predTitle:'🔮 Predviđanje',count:'Zabeleženih ciklusa',avg:'Prosečan ciklus',range:'Najkraći / Najduži',reg:'Redovnost',next:'Sledeća menstruacija',ovulation:'Ovulacija',fertile:'Plodni dani',confidence:'Pouzdanost',future:'Buduća predviđanja'},
  ...
  settings:{lang:'Jezik / Language / 语言',langHint:'Promeni jezik',theme:'Tema',themeHint:'Tamni / Svetli režim',cycle:'Dužina ciklusa',cycleHint:'Automatski, možeš i ručno',period:'Trajanje menstruacije',periodHint:'Trajanje svake menstruacije',override:'Ručne vrednosti',overrideHint:'Ignoriši automatski proračun',save:'💾 Sačuvaj',export:'📤 Izvezi (JSON)',import:'📥 Uvezi (JSON)',clear:'🗑 Obriši sve',clearConfirm:'Sigurna si? Ovo se ne može opozvati!',anniversary:'Godišnjica',anniversaryHint:'Dan kad ste počeli'},
...
'zh-CN': {
  appTitle:'Anđelin Ciklus', theme:'深色模式', themeHint:'切换深色/浅色主题',
  weekdays:['一','二','三','四','五','六','日'],
  months:['1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月'],
  today:'今天', tabs:['主页','统计','症状','日记','学中文','设置'],
  ...
  settings:{lang:'语言 / Language / Jezik',langHint:'切换界面语言',theme:'主题',themeHint:'深色/浅色模式',cycle:'默认周期长度',cycleHint:'系统自动计算，可手动覆盖',period:'默认经期天数',periodHint:'每次经期持续天数',override:'使用手动值预测',overrideHint:'开启后将忽略自动计算',save:'💾 保存设置',export:'📤 导出数据 (JSON)',import:'📥 导入数据 (JSON)',clear:'🗑 清除所有数据',clearConfirm:'确定清除所有数据？此操作不可恢复！',anniversary:'纪念日',anniversaryHint:'你们在一起的那一天'},
  ...
  reminder:{beforePeriod:'⏰ 预计 {days} 天后经期开始，提前准备哦',late:'⚠️ 经期已推迟 {days} 天，注意休息和调理',ovulation:'✨ 今天是排卵期，备孕的最佳时机'},
  cycleCounter:'一起走过 {n} 个周期', cycleCounterSub:'Barry 陪着你走过每一个周期 ♥',
  anniversaryTitle:'💕 重要的日子', annMetLabel:'✨ 初次相遇', annLoveLabel:'♥ 在一起的日子', annCountMet:'相遇 {n} 天 ✨', annCountLove:'相恋 {n} 天 ♥',
  yearTitle:'年度概览'
},
'en': {
  appTitle:'Anđelin Ciklus', theme:'Dark Mode', themeHint:'Switch between dark and light',
  weekdays:['Mon','Tue','Wed','Thu','Fri','Sat','Sun'],
  months:['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'],
  today:'Today', tabs:['Home','Stats','Symptoms','Diary','Learn','Settings'],
  ...
  cycleCounter:'Together: {n} cycles', cycleCounterSub:'Barry is with you every step ♥',
...
'sr': {
  ...
  profileSwitch: 'Profil promenjen', profileOnly: 'Samo Barry može ovo pregledati',
  ...
  sleepTitle:'Spavanje', sleepHint:'Kad si legao sinoc? Angie vidi tvoje vreme spavanja', sleepSave:'Sačuvaj', sleepEmpty:'Barry jos nije uneo vreme — podseti ga!',
  ...
  fabEndPeriod:'Kraj ciklusa', fabStartPeriod:'Početak ciklusa', fabEndYet:'Kraj mora biti posle početka', fabEndMarked:'Kraj ciklusa označen ✓', fabAlreadyMarked:' - već označeno',
  authPinBtn:'🔓 Prijavi se', authTapHint:'Dodirni za prijavu', authSwitchHint:'Unesi svoj PIN',
  gardenState0:'Klikni na emoji iznad da me zaliješ! 💧', gardenState1:'Prvi dan! Nastavi da me zalivaš svaki dan 🌱', gardenState3:'Rastem! Još malo pa cvetam 🌿', gardenState7:'Pupoljak! Tvoja ljubav me hrani 🌷', gardenStateBloom:'Procvetala! Kao i vaša ljubav 🌸',
  sdExportCopied:'Kopirano! Pošalji partneru 💌', sdExportCopiedSimple:'Kopirano!',
  songTitle:'🎵 Naša pesma', songMyLabel:'Moja pesma', songTitlePlaceholder:'Naziv pesme...', songNotePlaceholder:'Zašto baš ova pesma?', songSave:'Sačuvaj', songPartnerLabel:'pesma',
  songEmpty:'Postavite pesme koje vas podsećaju jedno na drugo', songSaveEmpty:'Unesi naziv pesme 🎵', songSaved:'🎵 Pesma sačuvana!',
  knowMeTitle:'💭 Da li me poznaješ?', knowMeMyLabel:'odgovor', knowMeAnswerSaved:'💭 Odgovor sačuvan!',
  hugTitle:'🤗 Virtuelni zagrljaj',
  gratTitle:'💝 Zid zahvalnosti', gratPlaceholder:'Hvala ti za...',
  ...
  modalHolidayLabel:'Praznik', modalSolarLabel:'Solarni ciklus', modalSpecialLabel:'Poseban dan',
  fabEndYet:'Kraj mora biti posle početka', fabEndMarked:'Kraj ciklusa označen ✓', fabAlreadyMarked:' - već označeno',
  sdDOW:['Ne','Po','Ut','Sr','Če','Pe','Su'], sdDOWMon:['Po','Ut','Sr','Če','Pe','Su','Ne'],
  sdExportPrompt:'Kopiraj i pošalji partneru:', sdSaveFirst:'Prvo sačuvaj svoj unos',
  sdImportTitle:'📥 Zalepi partnerov tekst', sdImportPlaceholder:'Zalepi JSON tekst ovde...',
  sdImportCancel:'Odustani', sdImportConfirm:'Uvezi', sdImportDone:'📥 Uvezeno! 💌', sdImportError:'Neispravan format 😢',
  sdQuestions:[{q:'💝 Obradovalo'},{q:'🤔 Zasmetalo'},{q:'🙏 Zahvalnost'},{q:'💪 Da poradimo'}],
  sdNoEntry:'Nema unosa', sdPartnerLocked:'Partner još nije napisao svoj osvrt za ovaj dan — ili još nije sinhronizovano.',
  sdTimelineLocked:'Zaključano', sdTimelineEmpty:'Još nema unosa — započnite danas! 💌',
  sdTimelineMore:'📅 Prikaži još',
  sdMyReflection:'Moj osvrt', sdMyHint:'Iskreno o danu — što više detalja, to bolje 💫',
  sdLabelHappy:'Šta me je danas obradovalo', sdLabelUncomf:'Šta mi je malo zasmetalo',
  sdLabelThanks:'Želim da ti se zahvalim za...', sdLabelWish:'Voleo/la bih da zajedno poradimo na...',
  sdSaveView:"Sačuvaj i pogledaj partnerov", sdGateHint:"Sačuvaj svoj unos pre nego što vidiš partnerov",
  sdPartnerReflection:"Partnerov osvrt",
  sdSyncHintOn:'☁️ Automatska sinhronizacija', sdSyncHintOff:'📤 Izvezi → pošalji partneru → Partner uveze',
  sdSyncJustNow:'malopre', sdSyncMinAgo:'min pre', sdSyncHAgo:'h pre',
  sdExportBtn:'Podeli', sdImportBtn:'Uvezi', sdTimelineTitle:'Vremenska linija',
  sdPartnerLockedText:'Prvo sačuvaj svoj unos da otključaš partnerov 💌',
  sdTranslateFail:'prevod nije uspeo',
  hugStreak:' dana zaredom!', hugReceived:' te zagrlio/la! 💫',
  hugBackBtn:'💝 Uzvrati zagrljaj', hugDismiss:'✕ zatvori',
  hugSentWaiting:'Zagrljaj poslat! Čekam odgovor... 💌', hugSendAnother:'Pošalji još jedan',
  hugSendBtn:'Pošalji zagrljaj', hugLimit:'Već si poslao/la 2 zagrljaja danas — probaj sutra! 🤗',
  hugSentBarry:'Poslao si joj zagrljaj!', hugSentAndjela:'Poslala si mu zagrljaj!',
  statsRegLabels:{high:'Visoka',medium:'Srednja',low:'Niska'},
  statsTrendTitle:'📈 Trend Ciklusa', statsTrendAvg:'Prosek', statsTrendEmpty:'Premalo podataka', statsTrendNeed:'Potrebno bar 2 ciklusa za trend',
  statsMoodTitle:'🎭 Distribucija Raspoloženja', statsMoodCenter:'unosa', statsMoodEmpty:'Nema podataka', statsMoodNoRecords:'Još nema zapisa o raspoloženju',
  statsSympTitle:'📋 Učestalost Simptoma', statsSympEmpty:'Nema podataka o simptomima', statsSympNoRecords:'Još nema zapisa o simptomima',
  statsDaysUntil:'Još', statsDaysUntilEnd:'dana', statsDaysLate:'Kasni', statsDaysLateEnd:'dana',
  statsConfidence:'Pouzdanost: ', statsNeedCycles:'(potrebno 2+ ciklusa)',
  statsOvLabel:'Ovulacija', statsFertLabel:'Plodni dani', statsFutureLabel:'Buduće', statsRegLabel:'Regularnost',
  statsTimelineTitle:'📜 Istorija Ciklusa', statsTimelineShort:'Kratak', statsTimelineNormal:'Normalan', statsTimelineLong:'Dug',
  statsHintCycles:'(treba bar 2 ciklusa)',
  holidayToday:'danas! 🎉', holidayDaysAway:'još', holidayOffLabel:'Odmor: ',
  modalLunar:'Lunarni', modalLunarSrSep:'. mesec, ', modalLunarSrDay:'. dan',
  loveCounterMet:' dana od prvog susreta', loveDaysTitle:'💕 Dani zajedno',
  solarTermBadge:'za',
  knowMePartnerLabel:' misli da je:', knowMeMatch:'Savršeno se razumete! ✨', knowMeWaiting:'Čeka se odgovor tvog partnera...',
  barryPhasePeriod:'Njena menstruacija', barryPhaseFollicular:'Njena folikularna', barryPhaseOvulation:'Njena ovulacija', barryPhaseLuteal:'Njena lutealna', barryPhaseGeneral:'Budi tu za nju',
  barryTipsTitle:'💡 Kako postupati prema njoj danas',
  phasePeriod:'Menstruacija', phaseFollicular:'Folikularna', phaseOvulation:'Ovulacija', phaseLuteal:'Lutealna',
},
'zh-CN': {
  profileName: 'Anđela', profileName2: 'Barry',
  ...
  sharedDiaryTab: '日记',
  profileSwitch: '已切换账号', profileOnly: '仅 Barry 可查看',
  ...
  sleepTitle:'睡眠', sleepHint:'昨晚几点睡的？Angie 会看到你的睡眠时间', sleepSave:'保存', sleepEmpty:'Barry 还没记录——提醒他！',
  sleepLabel:'昨晚他',
  specialBadgeTexts:['独一无二的你 ✨','最美的人 🌸','Barry 的爱 💝','世界上唯一的你 💫'],
  calendarPredLegend:'※ 半透明标记为未来周期预测',
  fabEndPeriod:'经期结束', fabStartPeriod:'经期来了', fabEndYet:'结束日必须在开始日之后', fabEndMarked:'经期结束已标记 ✓', fabAlreadyMarked:' - 已标记过',
  authPinBtn:'🔓 登录', authTapHint:'点击登录', authSwitchHint:'输入你的 PIN',
  gardenState0:'点上面的心情给我浇水！💧', gardenState1:'第一天！每天浇我哦 🌱', gardenState3:'在长大！快要开花了 🌿', gardenState7:'花苞！你的爱在滋养我 🌷', gardenStateBloom:'开花了！就像你们的爱 🌸',
  sdExportCopied:'已复制！发给伴侣吧 💌', sdExportCopiedSimple:'已复制！',
  songTitle:'🎵 我们的歌', songMyLabel:'我的歌', songTitlePlaceholder:'歌名...', songNotePlaceholder:'为什么是这首歌？', songSave:'保存', songPartnerLabel:'的歌',
  songEmpty:'设置让你们想到彼此的歌', songSaveEmpty:'请输入歌名 🎵', songSaved:'🎵 歌曲已保存！',
  knowMeTitle:'💭 你了解我吗？', knowMeMyLabel:'的回答', knowMeAnswerSaved:'💭 答案已保存！',
  hugTitle:'🤗 隔空拥抱',
  gratTitle:'💝 感恩便签', gratPlaceholder:'谢谢你...',
  checkinTitle:'🎯 每周感情体检',
  teaTitle:'🍵 茶室 — 塞尔维亚 ♥ 中国',
  ...
  modalHolidayLabel:'节日', modalSolarLabel:'节气', modalSpecialLabel:'特殊日子',
  sdDOW:['日','一','二','三','四','五','六'], sdDOWMon:['一','二','三','四','五','六','日'],
  sdExportPrompt:'复制发给伴侣：', sdSaveFirst:'请先保存你的日记',
  sdImportTitle:'📥 粘贴伴侣分享的内容', sdImportPlaceholder:'粘贴 JSON 文本...',
  sdImportCancel:'取消', sdImportConfirm:'导入', sdImportDone:'已导入！💌', sdImportError:'格式不对哦 😢',
  sdQuestions:[{q:'💝 开心的事'},{q:'🤔 不舒服的事'},{q:'🙏 感谢'},{q:'💪 希望改进'}],
  sdNoEntry:'没有记录', sdPartnerLocked:'伴侣还没写这一天的总结——或者还没同步过来。',
  sdTimelineLocked:'已锁定', sdTimelineEmpty:'还没有日记——今天就开始吧！💌',
  sdTimelineMore:'📅 展开剩余',
  sdMyReflection:'我的总结', sdMyHint:'坦诚地回顾一天——越详细越好 💫',
  sdLabelHappy:'今天让我开心的事', sdLabelUncomf:'让我有点不舒服的事',
  sdLabelThanks:'我想感谢你的...', sdLabelWish:'我希望我们能一起改进的...',
  sdSaveView:'保存并查看伴侣的', sdGateHint:'写完才能看伴侣的哦',
  sdPartnerReflection:'伴侣的总结',
  sdSyncHintOn:'☁️ 自动同步中', sdSyncHintOff:'📤 导出 → 发给伴侣 → 导入',
  sdSyncJustNow:'刚刚', sdSyncMinAgo:'分钟前', sdSyncHAgo:'小时前',
  sdExportBtn:'分享', sdImportBtn:'导入', sdTimelineTitle:'时间线',
  sdPartnerLockedText:'先保存你的日记才能解锁伴侣的哦 💌',
  sdTranslateFail:'翻译失败',
  hugStreak:'天连续！', hugReceived:'抱了你！💫',
  hugBackBtn:'回抱一个', hugDismiss:'✕ 关闭',
  hugSentWaiting:'拥抱已发送！等待回应... 💌', hugSendAnother:'再抱一次',
  hugSendBtn:'发送拥抱', hugLimit:'今天已经抱了2次——明天再来！🤗',
  hugSentBarry:'拥抱已发送！', hugSentAndjela:'拥抱已发送！',
  statsRegLabels:{high:'高',medium:'中',low:'低'},
  statsTrendTitle:'📈 周期趋势', statsTrendAvg:'均值', statsTrendEmpty:'数据不足', statsTrendNeed:'需要至少2个周期才显示趋势',
  statsMoodTitle:'🎭 心情分布', statsMoodCenter:'次记录', statsMoodEmpty:'暂无心情数据', statsMoodNoRecords:'还没有心情记录',
  statsSympTitle:'📋 症状频率', statsSympEmpty:'暂无症状数据', statsSympNoRecords:'还没有症状记录',
  statsDaysUntil:'距下次', statsDaysUntilEnd:'天', statsDaysLate:'已推迟', statsDaysLateEnd:'天',
  statsConfidence:'置信度：', statsNeedCycles:'(需2个周期以上)',
  statsOvLabel:'排卵日', statsFertLabel:'易孕窗口', statsFutureLabel:'未来预测', statsRegLabel:'规律性',
  statsTimelineTitle:'📜 周期历史', statsTimelineShort:'偏短', statsTimelineNormal:'正常', statsTimelineLong:'偏长',
  statsHintCycles:'(需2个周期以上)',
  holidayToday:'就是今天！🎉', holidayDaysAway:'还有', holidayOffLabel:'放假',
  modalLunar:'农历', modalLunarSrSep:'月', modalLunarSrDay:'日',
  loveCounterMet:' 天前初次相遇', loveDaysTitle:'💕 我们的日子',
  solarTermBadge:'',
  knowMePartnerLabel:'认为:', knowMeMatch:'你们太有默契了！✨', knowMeWaiting:'等待对方回答...',
  barryPhasePeriod:'她的经期', barryPhaseFollicular:'她的卵泡期', barryPhaseOvulation:'她的排卵期', barryPhaseLuteal:'她的黄体期', barryPhaseGeneral:'好好待她',
  barryTipsTitle:'💡 今天如何对待她',
  phasePeriod:'经期', phaseFollicular:'卵泡期', phaseOvulation:'排卵期', phaseLuteal:'黄体期',
},
'en': {
  profileName: 'Anđela', profileName2: 'Barry',
  ...
  streakLabel: 'day streak!', streakLabel0: 'Start a streak!', streakBadgeHot: 'Amazing! 🔥', streakBadgeWarm: 'Nice ✨', streakBadgeCold: 'Start today 🌱',
  ...
  profileSwitch: 'Profile switched', profileOnly: 'Only Barry can view this',
  ...
  sleepTitle:'Sleep', sleepHint:'What time did you sleep last night? Angie sees your sleep time', sleepSave:'Save', sleepEmpty:"Barry hasn't logged sleep yet — remind him!",
  ...
  fabEndPeriod:'Period ended', fabStartPeriod:'Period started', fabEndYet:'End must be after start', fabEndMarked:'Period end marked ✓', fabAlreadyMarked:' - already marked',
  authPinBtn:'🔓 Sign in', authTapHint:'Tap to sign in', authSwitchHint:'Enter your PIN',
  gardenState0:'Tap an emoji above to water me! 💧', gardenState1:'First day! Keep watering me daily 🌱', gardenState3:'Growing! Almost blooming 🌿', gardenState7:'Budding! Your love feeds me 🌷', gardenStateBloom:'Bloomed! Just like your love 🌸',
  sdExportCopied:"Copied! Send to partner 💌", sdExportCopiedSimple:'Copied!',
  songTitle:'🎵 Our Song', songMyLabel:'My song', songTitlePlaceholder:'Song title...', songNotePlaceholder:'Why this song?', songSave:'Save', songPartnerLabel:'song',
  songEmpty:'Set songs that remind you of each other', songSaveEmpty:'Enter a song title 🎵', songSaved:'🎵 Song saved!',
  knowMeTitle:'💭 Do You Know Me?', knowMeMyLabel:' answer', knowMeAnswerSaved:'💭 Answer saved!',
  hugTitle:'🤗 Virtual Hug',
  gratTitle:'💝 Gratitude Wall', gratPlaceholder:'Thank you for...',
  ...
  modalHolidayLabel:'Holiday', modalSolarLabel:'Solar Term', modalSpecialLabel:'Special Day',
  sdDOW:['Su','Mo','Tu','We','Th','Fr','Sa'], sdDOWMon:['Mo','Tu','We','Th','Fr','Sa','Su'],
  sdExportPrompt:'Copy and send to partner:', sdSaveFirst:'Save your entry first',
  sdImportTitle:"📥 Paste partner's text", sdImportPlaceholder:'Paste JSON text here...',
  sdImportCancel:'Cancel', sdImportConfirm:'Import', sdImportDone:"📥 Imported! 💌", sdImportError:'Invalid format 😢',
  sdQuestions:[{q:'💝 Happy'},{q:'🤔 Uncomfortable'},{q:'🙏 Thanks'},{q:'💪 To improve'}],
  sdNoEntry:'No entry', sdPartnerLocked:"Your partner hasn't written their reflection for this day yet — or it hasn't synced.",
  sdTimelineLocked:'🔒 Locked', sdTimelineEmpty:"No entries yet — start today! 💌",
  sdTimelineMore:'📅 Show',
  sdMyReflection:'My Reflection', sdMyHint:'Be honest about your day — the more detail the better 💫',
  sdLabelHappy:'What made me happy today', sdLabelUncomf:'What felt a little uncomfortable',
  sdLabelThanks:'I want to thank you for...', sdLabelWish:'I hope we can work on...',
  sdSaveView:"Save & View Partner's", sdGateHint:"Save your entry to unlock your partner's",
  sdPartnerReflection:"Partner's Reflection",
  sdSyncHintOn:'☁️ Auto-sync on', sdSyncHintOff:'📤 Export → send → Partner imports',
  sdSyncJustNow:'just now', sdSyncMinAgo:'min ago', sdSyncHAgo:'h ago',
  sdExportBtn:'Share', sdImportBtn:'Import', sdTimelineTitle:'Timeline',
  sdPartnerLockedText:"Save your entry first to unlock your partner's 💌",
  sdTranslateFail:'translation failed',
  hugStreak:'-day streak!', hugReceived:' hugged you! 💫',
  hugBackBtn:'💝 Hug back', hugDismiss:'✕ dismiss',
  hugSentWaiting:'Hug sent! Waiting for response... 💌', hugSendAnother:'Send another',
  hugSendBtn:'Send a Hug', hugLimit:'You already sent 2 hugs today — try tomorrow! 🤗',
  hugSentBarry:'Hug sent!', hugSentAndjela:'Hug sent!',
  statsRegLabels:{high:'High',medium:'Medium',low:'Low'},
  statsTrendTitle:'📈 Cycle Trend', statsTrendAvg:'Avg', statsTrendEmpty:'Not enough data', statsTrendNeed:'Need 2+ cycles for trend',
  statsMoodTitle:'🎭 Mood Distribution', statsMoodCenter:'entries', statsMoodEmpty:'No mood data', statsMoodNoRecords:'No mood records yet',
  statsSympTitle:'📋 Symptom Frequency', statsSympEmpty:'No symptom data', statsSympNoRecords:'No symptom records yet',
  statsDaysUntil:'', statsDaysUntilEnd:'days until', statsDaysLate:'', statsDaysLateEnd:'days late',
  statsConfidence:'Confidence: ', statsNeedCycles:'(needs 2+ cycles)',
  statsOvLabel:'Ovulation', statsFertLabel:'Fertile Window', statsFutureLabel:'Future', statsRegLabel:'Regularity',
  statsTimelineTitle:'📜 Cycle History', statsTimelineShort:'Short', statsTimelineNormal:'Normal', statsTimelineLong:'Long',
  statsHintCycles:'(needs 2+ cycles)',
  holidayToday:'today! 🎉', holidayDaysAway:'', holidayOffLabel:'Days off: ',
  modalLunar:'Lunar', modalLunarSrSep:'/', modalLunarSrDay:'',
  loveCounterMet:' days since we met', loveDaysTitle:'💕 Our Days',
  solarTermBadge:'in',
  knowMePartnerLabel:' thinks it is:', knowMeMatch:'You two are perfectly in sync! ✨', knowMeWaiting:'Waiting for your partner to answer...',
...
const LOVE_NOTES = (function(){
  ...
  function get(){ const arr=lang==='zh-CN'?zh:lang==='en'?en:sr; const day=Math.floor(Date.now()/86400000); return arr[day%arr.length]; }
  return {get:get};
})();
