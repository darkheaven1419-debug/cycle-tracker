...
if(typeof pullAllSharedData==='function'){console.log('[同步] 日记tab激活，自动拉取...');setTimeout(function(){pullAllSharedData();},300);}}});_dpMo.observe(_dp,{attributes:true,attributeFilter:['class']});}
